...
class TestMesh(FixturedTestCase):
    ...
    def test_assign_neighbours(self):
        ...
        self.assertSetEqual(self.block_0.neighbours, {self.block_1, self.block_2})

        self.assertSetEqual(self.block_1.neighbours, {self.block_0, self.block_2})

        self.assertSetEqual(self.block_2.neighbours, {self.block_0, self.block_1})
