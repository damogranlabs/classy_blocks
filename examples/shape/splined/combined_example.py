...
circular_sketch_1 = cb.SplineDisk(center_point=center_point,
...
elliptical_sketch_1 = cb.SplineDisk(center_point=center_point + direction * 1,
                                    corner_1_point=np.asarray([0, 1, 0]) + direction * 1,
                                    corner_2_point=np.asarray([0, 0, 1.2]) + direction * 1,
                                    side_1=0, side_2=0, n_outer_spline_points=50)

elliptical_sketch_2 = cb.SplineDisk(center_point=center_point + direction * 2,
                                    corner_1_point=np.asarray([0, 1, 0]) + direction * 2,
                                    corner_2_point=np.asarray([0, 0, 1.5]) + direction * 2,
                                    side_1=0, side_2=0)

elliptical_sketch_3 = cb.SplineDisk(center_point=center_point + direction * 3,
...
oval_sketch_1 = cb.SplineDisk(center_point=center_point + direction * 3.4,
...
oval_sketch_2 = cb.SplineDisk(center_point=center_point + direction * 4,
                              corner_1_point=np.asarray([0, 1.5, 0]) + direction * 4,
                              corner_2_point=np.asarray([0, 0, 2.5]) + direction * 4,
                              side_1=0.8, side_2=1.8, n_straight_spline_points=100)
