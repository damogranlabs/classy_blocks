...
nozzle.set_axial_cell_size(-outer_cell_size)
nozzle.set_outer_patch('wall')
mesh.add_shape(nozzle)
...
chamber_inner.set_axial_cell_size(outer_cell_size)
mesh.add_shape(chamber_inner)
