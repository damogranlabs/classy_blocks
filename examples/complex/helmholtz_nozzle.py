...
from classy_blocks import Face, Cylinder, Frustum, RevolvedRing, Mesh
...
# inlet
inlet = Cylinder([0, 0, 0], [l_inlet, 0, 0], [0, 0, r_inlet])
...
# nozzle
nozzle = Frustum.chain(inlet, l_nozzle, r_nozzle)
...
chamber_inner = Cylinder.chain(nozzle, l_chamber_inner)
...
# outlet pipe
outlet = Cylinder.chain(chamber_inner, l_outlet)
